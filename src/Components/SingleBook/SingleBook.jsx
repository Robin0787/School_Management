...
const SingleBook = ({ subject }) => {
    return (
        <div className='border dark:border-gray-600 rounded-md relative w-full md:w-[180px] mx-auto group overflow-hidden md:hover:scale-110 hover:shadow-md shadow-black dark:shadow-gray-600 duration-500'>
