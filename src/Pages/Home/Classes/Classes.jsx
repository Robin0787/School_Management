...
const Classes = () => {
    AOS.init();
    return (
        <section  className="pt-16 overflow-hidden" id='book-list'>
            <Container>
                <section className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-5 capitalize">
                    <Link to={'/subjects/class/6'}
                        data-aos="fade-right" data-aos-delay="100"  data-aos-once="false" data-aos-mirror="false"
                        className="class-six">
                    ...
                    <Link to={'/subjects/class/8'}
                        data-aos="zoom-in-down" data-aos-delay="200"  data-aos-once="false" data-aos-mirror="false"
                    ...
                    <Link to={'/subjects/class/9'}
                        data-aos="fade-left" data-aos-delay="50"  data-aos-once="false" data-aos-mirror="false"
                    ...
                    <Link to={'/subjects/class/10'}
                        data-aos="fade-left" data-aos-delay="100"  data-aos-once="false" data-aos-mirror="false"
                        className="class-ten">
