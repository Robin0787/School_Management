    ...
    return (
        <section className="bg-white text-black dark:bg-[#0f172a] dark:text-white">
            <section className="py-20 ">
                <Container>
                    <article className="flex flex-col md:flex-row justify-between items-center gap-5 overflow-hidden">
                        <div className="w-full md:w-1/2 space-y-5" data-aos="zoom-in-up"
                        data-aos-mirror="false"  data-aos-once="false">
                            <h1 className="text-3xl sm:text-5xl font-bold uppercase text-center sm:text-start md:whitespace-nowrap">Welcome To Our <span className="text-[#00db50]">NAPHS</span></h1>
                        ...
                        <div className="w-full md:w-1/2" data-aos="zoom-in-up"
                         data-aos-once="false" data-aos-mirror="false">
