    ...
    return (
        <section className="flex justify-center items-center bg-white text-black dark:bg-[#0f172a] dark:text-white py-20">
            <section>
                ...
                <h1 
                className="text-black dark:text-gray-200 text-2xl md:text-3xl text-center tracking-[2px] uppercase whitespace-nowrap pb-10 md:pb-16">Student SignUp Form</h1>
